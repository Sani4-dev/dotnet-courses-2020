...
namespace Task1
{
    public class DynamicArray<T> : IEnumerable where T : class, new()
    {
        ...
        public DynamicArray(IEnumerable<T> enumerableArray)
        {
            var listHelper = new List<T>();
            ...
            _arrayOfT = new T[listHelper.Count];
            _arrayOfT = listHelper.ToArray();
        }
        ...
        {
            return new DynamicArrayEnumerator<T>(_arrayOfT);
        }
    }
}
